    ...
    <>
      <header className="header-container">
        <nav className="navigation">
          ...
          <form autoComplete="off" className="relative search-form">
            <input 
              className="TopSearch_searchInput__Nbapa" 
              id="search-input" 
              placeholder={t('common.searchPlaceholder', 'Search for games...')}
            />
          </form>
          <button className="hamburger-btn" onClick={openSideMenu}>
