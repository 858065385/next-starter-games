      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600">{footer.copyright || '© 2025 Multilingual App. All rights reserved.'}</p>
          </div>
          ...
          {/* 联系方式 */}
          <div>
            <h3 className="text-lg font-semibold mb-4">{footer.contact || 'Contact Us'}</h3>
